...
export default class Body {
    ...
    reset(x, y, z) {
        ...
        this.position.x =
            x + (this.widthX * -this.sprite.anchor.x + this.widthX * 0.5) + this.offset.x;
        this.position.y =
            y + (this.widthY * this.sprite.anchor.x - this.widthY * 0.5) + this.offset.y;
        this.position.z =
            z -
    ...
    onWall() {
        return (
            this.blocked.frontX || this.blocked.frontY || this.blocked.backX || this.blocked.backY
        );
    }
